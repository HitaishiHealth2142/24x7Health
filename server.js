...
/* =====================
   Static Files (LAST)
===================== */
// app.use(express.static(path.join(__dirname, 'public')));   //production static files

app.use(express.static(path.join(__dirname)));   //root directory for development (to serve index.html, etc.)
